## Makefile movido a project_scripts/Makefile
## Use `make -f project_scripts/Makefile <target>` o invocar desde project_scripts.

all:
	@echo "Use project_scripts/Makefile for development tasks"
