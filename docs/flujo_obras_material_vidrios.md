...
#
# Checklist de integración y pendientes (actualizado al 2025-06-25):
#
# [x] Vidrios: unificar gestión de vidrios en tabla vidrios_por_obra exclusivamente.
...
# [x] Obras: agregar columnas de estado (estado_material, estado_vidrios, estado_herrajes, estado_pago).
...
# [x] Contabilidad: agregar método obtener_estado_pago_pedido_por_obra.
...
# [x] Integración visual: tabla de obras muestra estados de pedidos con colores diferenciados (25/06/2025).
#
# ACTUALIZACIÓN 25/06/2025:
# - La tabla de obras ahora incluye columnas virtuales para mostrar estados de pedidos de todos los módulos.
# - Los estados se consultan automáticamente al cargar la tabla y se muestran con colores diferenciados.
