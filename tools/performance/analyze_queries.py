...
class QueryAnalyzer:
    ...
    def _find_n_plus_one_issues(self, content: str, file_path: Path) -> List[Dict[str, Any]]:
    ...
    def _find_slow_query_issues(self, content: str, file_path: Path) -> List[Dict[str, Any]]:
    ...
    def _find_pagination_issues(self, content: str, file_path: Path) -> List[Dict[str, Any]]:
    ...
    def _find_optimization_opportunities(self, content: str, file_path: Path) -> List[Dict[str, Any]]:
