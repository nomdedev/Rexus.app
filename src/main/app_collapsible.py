...
class SimpleSecurityManager:
    ...
    def get_user_modules(self, user_id: int) -> list:
        return ["inventario", "obras", "pedidos", "logistica", "herrajes", "vidrios", "usuarios", "auditoria", "configuracion", "compras", "mantenimiento", "administracion"]
...
def main():
    ...
    def handle_login_success(username, role):
