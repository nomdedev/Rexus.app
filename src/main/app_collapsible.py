...
class SimpleSecurityManager:
    ...
    def __init__(self):
        ...
        # Las contraseñas deben estar hasheadas y nunca en texto plano
        # Solo para fallback/demo, NO usar en producción
        self.users = {
            "admin": {"rol": "ADMIN", "id": 1, "username": "admin", "password": "admin"}
        }

    def login(self, username: str, password: str) -> bool:
        """Autenticación simple (solo para fallback/demo)"""
