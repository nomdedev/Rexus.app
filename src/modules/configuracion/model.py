...
class ConfiguracionModel:
    ...
    CONFIG_DEFAULTS = {
        ...
        # Empresa
        'empresa_nombre': 'Rexus Construction',
        'empresa_nit': '900123456-1',
        'empresa_direccion': 'Calle 123 #45-67',
        'empresa_telefono': '+57 1 234 5678',
        'empresa_email': 'info@rexus.com',
        'empresa_web': 'www.rexus.com',
        'empresa_logo': '',
        'empresa_moneda': 'COP',
    ...
    def establecer_valor(self, clave: str, valor: Any, usuario: str = "SISTEMA") -> Tuple[bool, str]:
        """
    ...
    def obtener_configuracion_por_categoria(self, categoria: str) -> Dict[str, Any]:
        ...
        if not self.db_connection:
            ...
            return {k: v for k, v in self.config_cache.items() 
        ...
        try:
            ...
            print(f"[ERROR CONFIGURACION] Error obteniendo configuración por categoría: {e}")
            return {}
    ...
    def obtener_todas_configuraciones(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"[ERROR CONFIGURACION] Error obteniendo todas las configuraciones: {e}")
            return self._get_configuraciones_demo()
    
    def restaurar_configuracion_defecto(self, clave: str, usuario: str = "SISTEMA") -> Tuple[bool, str]:
        """
    ...
    def importar_configuracion(self, archivo: str, usuario: str = "SISTEMA") -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            for config in configuraciones:
                if isinstance(config, dict) and 'clave' in config and 'valor' in config:
                    exito, _ = self.establecer_valor(config['clave'], config['valor'], usuario)
                    if exito:
                        contador += 1
