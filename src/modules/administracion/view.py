...
class AdministracionView(QWidget):
    ...
    def create_dashboard_tab(self):
        ...
        empleados_title.setStyleSheet("font-size: 16px; font-weight: bold; color: #2c3e50;")
        ...
        financiero_title.setStyleSheet("font-size: 16px; font-weight: bold; color: #2c3e50;")
    ...
    def create_empleados_tab(self):
        ...
        self.empleados_estado_combo.addItems(["Todos", "ACTIVO", "INACTIVO", "VACACIONES", "LICENCIA"])
        ...
        self.tabla_empleados.setHorizontalHeaderLabels([
            "ID", "Código", "Nombre", "Apellido", "DNI", "Teléfono",
            "Departamento", "Cargo", "Salario", "Fecha Ingreso", "Estado", "Acciones"
        ])
    ...
    def create_nomina_tab(self):
        ...
        self.tabla_nomina.setHorizontalHeaderLabels([
            "Empleado", "Salario Base", "Bonos", "Descuentos", "Días Trabajados",
            "Horas Extra", "Faltas", "Bruto", "Descuentos", "Neto"
        ])
    ...
    def create_asistencias_tab(self):
        ...
        self.tabla_asistencias.setHorizontalHeaderLabels([
            ...
            "Horas Trabajadas", "Horas Extra", "Tipo", "Observaciones"
        ])
    ...
    def create_bonos_tab(self):
        ...
        self.tabla_bonos.setHorizontalHeaderLabels([
            "Empleado", "Tipo", "Concepto", "Monto", "Fecha", 
            "Período", "Estado", "Aplicado", "Acciones"
        ])
    ...
    def create_historial_tab(self):
        ...
        self.historial_tipo_combo.addItems([
            "Todos", "CONTRATACION", "PROMOCION", "CAMBIO_SALARIO", 
            "CAMBIO_DEPARTAMENTO", "LICENCIA", "VACACIONES", "RENUNCIA", "DESPIDO"
        ])
        ...
        self.tabla_historial.setHorizontalHeaderLabels([
            "Empleado", "Tipo", "Descripción", "Fecha", 
            "Valor Anterior", "Valor Nuevo", "Usuario"
        ])
    ...
    def create_libro_contable_tab(self):
        ...
        self.tabla_libro.setHorizontalHeaderLabels([
            "ID", "Número", "Fecha", "Tipo", "Concepto", "Referencia",
            "Debe", "Haber", "Saldo", "Estado", "Usuario", "Acciones"
        ])
    ...
    def create_recibos_tab(self):
        ...
        self.tabla_recibos.setHorizontalHeaderLabels([
            "ID", "Número", "Fecha", "Tipo", "Concepto", "Beneficiario",
            "Monto", "Moneda", "Estado", "Impreso", "Acciones"
        ])
    ...
    def create_pagos_obra_tab(self):
        ...
        self.tabla_pagos_obra.setHorizontalHeaderLabels([
            "ID", "Obra", "Concepto", "Categoría", "Monto", 
            "Fecha", "Método Pago", "Estado", "Usuario", "Acciones"
        ])
    ...
    def create_materiales_tab(self):
        ...
        self.tabla_materiales.setHorizontalHeaderLabels([
            "ID", "Producto", "Proveedor", "Cantidad", "Precio Unit.",
            "Total", "Pagado", "Pendiente", "Estado", "Fecha", "Acciones"
        ])
    ...
    def create_auditoria_tab(self):
        ...
        self.auditoria_tabla_combo.addItems([
            "Todas", "libro_contable", "recibos", "empleados", "nomina",
            "asistencias", "bonos", "pagos_obras", "pagos_materiales"
        ])
        ...
        self.tabla_auditoria.setHorizontalHeaderLabels([
            "ID", "Tabla", "Registro", "Acción", "Usuario", 
            "Fecha", "Datos Anteriores", "Datos Nuevos"
        ])
