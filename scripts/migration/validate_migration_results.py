...
class MigrationValidator:
    ...
    def check_indexes_created(self):
        ...
        try:
            ...
            cursor.execute("""
                ...
                WHERE t.name IN ('productos', 'pedidos_consolidado', 'productos_obra', 'movimientos_inventario')
    ...
    def run_validation(self):
        ...
        try:
            ...
            if 'pedidos_consolidado' in table_results and table_results['pedidos_consolidado']:
