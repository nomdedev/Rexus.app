#!/usr/bin/env python3
"""
Script para corregir archivo detalle_model.py con problemas de indentación críticos
"""

import re

# Contenido corregido para reemplazar la sección problemática
corrected_content = '''"""
...
print("Corrigiendo rexus/modules/compras/detalle_model.py...")
with open("rexus/modules/compras/detalle_model.py", "w", encoding="utf-8") as f:
...
import py_compile
try:
    py_compile.compile("rexus/modules/compras/detalle_model.py", doraise=True)
