...
class SQLInjectionFixer:
    ...
    def fix_f_string_queries(self, file_path: str, line_num: int, line_content: str) -> str:
    ...
    def fix_format_queries(self, file_path: str, line_num: int, line_content: str) -> str:
