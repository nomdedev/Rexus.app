...
class UsuariosModel:
    ...
    def __init__(self, db_connection=None):
        ...
        if db_connection is None:
            # Intentar establecer conexión usando función centralizada
            try:
                from rexus.core.database import get_users_connection
                db_connection = get_users_connection()
                logger.info("UsuariosModel estableció conexión automáticamente")
            except Exception as e:
                logger.warning(f"No se pudo establecer conexión automática: {e} - usando modo limitado")
                db_connection = None
        else:
