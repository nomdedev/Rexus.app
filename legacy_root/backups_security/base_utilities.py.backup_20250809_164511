...
class BaseUtilities:
    ...
    def sanitizar_entrada(self, value: Any, tipo: str = 'string', max_length: int = None) -> Any:
        """
    ...
    def convertir_fila_a_dict(self, row: Tuple, columnas: List[str]) -> Dict[str, Any]:
        """
    ...
    def log_operacion(self, operacion: str, detalles: str = "", nivel: str = "INFO") -> None:
        """
