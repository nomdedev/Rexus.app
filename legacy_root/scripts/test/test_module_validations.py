...
def test_inventario_validator():
    ...
    try:
        from src.utils.module_validators import inventario_validator
        ...
        print(f"  [FAIL] Inventario validator test failed: {e}")
        return False
...
def test_herrajes_validator():
    ...
    try:
        from src.utils.module_validators import herrajes_validator
        ...
        print(f"  [FAIL] Herrajes validator test failed: {e}")
        return False
...
def test_vidrios_validator():
    ...
    try:
        from src.utils.module_validators import vidrios_validator
        ...
        print(f"  [FAIL] Vidrios validator test failed: {e}")
        return False
...
def test_pedidos_validator():
    ...
    try:
        from src.utils.module_validators import pedidos_validator
        ...
        print(f"  [FAIL] Pedidos validator test failed: {e}")
        return False
...
def test_obras_validator():
    ...
    try:
        from src.utils.module_validators import obras_validator
        ...
        print(f"  [FAIL] Obras validator test failed: {e}")
        return False
...
def test_module_validator_function():
    ...
    try:
        ...
        print(f"  [FAIL] Module validator function test failed: {e}")
        return False
...
def test_edge_cases():
    ...
    try:
        from src.utils.module_validators import inventario_validator, herrajes_validator
...
def main():
    ...
    # Overall assessment
    if success_rate >= 90:
        print("\n[SUCCESS] Module validations working correctly!")
        print("- All form validators operational")
        print("- Edge cases handled properly")
        print("- Module-specific validation rules working")
        print("- Boundary conditions tested successfully")
        return True
    elif success_rate >= 70:
        print("\n[ACCEPTABLE] Most validation features working")
        print("- Minor issues detected but core validation operational")
        return True
    else:
        print("\n[CRITICAL] Multiple validation issues detected")
        print("- Review failed tests and address validation problems")
        return False
