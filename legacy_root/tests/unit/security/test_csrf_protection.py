...
class TestCSRFToken:
    ...
    def test_validate_token_valid_token(self):
        ...
        is_valid,
message = csrf_token.validate_token(token,
            user_id,
            session_id)
...
message = csrf_token.validate_token(token,
    ...
    def test_validate_token_invalid_format(self):
        ...
        for invalid_token in invalid_tokens:
            is_valid,
message = csrf_token.validate_token(invalid_token,
                "user1",
                "session1")
            assert not is_valid
...
class TestCSRFProtection:
    ...
    def test_validate_token_for_user_valid(self):
        ...
        # Validar token
        is_valid,
message = csrf_protection.validate_token_for_user(token,
            user_id,
            session_id,
            consume=False)
    ...
    def test_validate_token_for_user_consume_once(self):
        ...
        is_valid1,
message1 = csrf_protection.validate_token_for_user(token,
            user_id,
            consume=True)
        assert is_valid1
        ...
        is_valid2,
message2 = csrf_protection.validate_token_for_user(token,
            user_id,
            consume=True)
...
class TestCSRFProtectionIntegration:
    ...
    def test_full_csrf_workflow(self):
        ...
        csrf_protection = get_csrf_protection()
        is_valid1,
msg1 = csrf_protection.validate_token_for_user(token,
            user_id,
            session_id,
            consume=False)
        assert is_valid1
        ...
        is_valid2,
msg2 = csrf_protection.validate_token_for_user(token,
            user_id,
            session_id,
            consume=True)
        assert is_valid2
        ...
        is_valid3,
msg3 = csrf_protection.validate_token_for_user(token,
            user_id,
            session_id,
            consume=True)
