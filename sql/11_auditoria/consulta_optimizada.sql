...
-- Archivo original: D:\martin\Rexus.app\rexus\modules\auditoria\model.py
-- Línea original: 165
...
CREATE INDEX IF NOT EXISTS idx_auditoria_tabla_principal_xtype ON tabla_principal(xtype);
CREATE INDEX IF NOT EXISTS idx_auditoria_tabla_principal_name ON tabla_principal(name);
...
-- resultado = sql_manager.ejecutar_consulta_archivo('sql/auditoria/consulta_optimizada.sql', parametros)