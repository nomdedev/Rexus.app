...
-- Archivo original: D:\martin\Rexus.app\rexus\modules\administracion\contabilidad\model.py
-- Línea original: 99
...
-- resultado = sql_manager.ejecutar_consulta_archivo('sql/administracion/consulta_optimizada.sql', parametros)