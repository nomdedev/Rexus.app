...
-- Archivo original: D:\martin\Rexus.app\rexus\modules\compras\proveedores_model.py
-- Línea original: 37
...
CREATE INDEX IF NOT EXISTS idx_compras_tabla_principal_xtype ON tabla_principal(xtype);
CREATE INDEX IF NOT EXISTS idx_compras_tabla_principal_name ON tabla_principal(name);
...
-- resultado = sql_manager.ejecutar_consulta_archivo('sql/compras/consulta_optimizada_2.sql', parametros)