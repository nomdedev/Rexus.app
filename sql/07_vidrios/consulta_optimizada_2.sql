...
-- Archivo original: D:\martin\Rexus.app\rexus\modules\vidrios\model.py
-- Línea original: 308
...
CREATE INDEX IF NOT EXISTS idx_vidrios_tabla_principal_xtype ON tabla_principal(xtype);
CREATE INDEX IF NOT EXISTS idx_vidrios_tabla_principal_name ON tabla_principal(name);
...
-- resultado = sql_manager.ejecutar_consulta_archivo('sql/vidrios/consulta_optimizada_2.sql', parametros)