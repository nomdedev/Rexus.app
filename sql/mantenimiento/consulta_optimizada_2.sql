...
CREATE INDEX IF NOT EXISTS idx_mantenimiento_tabla_principal_xtype ON tabla_principal(xtype);
CREATE INDEX IF NOT EXISTS idx_mantenimiento_tabla_principal_name ON tabla_principal(name);
...
-- resultado = sql_manager.ejecutar_consulta_archivo('sql/mantenimiento/consulta_optimizada_2.sql', parametros)