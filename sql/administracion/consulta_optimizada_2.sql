-- consulta_optimizada_2.sql
-- Módulo: administracion
-- Generado automáticamente el: 2025-08-22 23:18:58
-- Archivo original: D:\martin\Rexus.app\rexus\modules\administracion\recursos_humanos\model.py
-- Línea original: 60
...
CREATE INDEX IF NOT EXISTS idx_administracion_tabla_principal_xtype ON tabla_principal(xtype);
CREATE INDEX IF NOT EXISTS idx_administracion_tabla_principal_name ON tabla_principal(name);
...
-- resultado = sql_manager.ejecutar_consulta_archivo('sql/administracion/consulta_optimizada_2.sql', parametros)