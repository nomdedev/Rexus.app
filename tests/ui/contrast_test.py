...
class ContrastAnalyzer:
    ...
    def _analyze_qss_line(self, file_path: Path, line_num: int, line: str) -> List[ContrastIssue]:
    ...
    def _analyze_color_usage(self, file_path: Path, line_num: int, line: str) -> List[ContrastIssue]:
