...
class TestMovimientosManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with (
            patch(
                "rexus.modules.inventario.submodules.movimientos_manager.DatabaseManager",
                return_value=self.mock_db,
            ),
            patch(
                "rexus.modules.inventario.submodules.movimientos_manager.DataSanitizer",
                return_value=self.mock_sanitizer,
            ),
        ):
    ...
    def test_registrar_salida_stock_insuficiente(self):
        ...
        datos_salida = {"producto_id": 1, "cantidad": 25, "motivo": "Venta"}
    ...
    def test_validar_movimiento_datos_validos(self):
        ...
        datos_validos = {"producto_id": 1, "cantidad": 25, "motivo": "Transferencia"}
    ...
    def test_validar_movimiento_datos_invalidos(self):
        ...
        # Cantidad negativa
        datos_invalidos = {"producto_id": 1, "cantidad": -5, "motivo": "Test"}
    ...
    def test_obtener_resumen_movimientos_periodo(self):
        ...
        resumen = self.manager.obtener_resumen_movimientos_periodo(
    ...
    def test_manejo_errores_base_datos(self):
        ...
        datos_entrada = {"producto_id": 1, "cantidad": 10, "motivo": "Test error"}
...
class TestMovimientosManagerIntegracion(unittest.TestCase):
    ...
    def test_flujo_completo_movimientos(self, mock_sanitizer_class, mock_db_class):
        ...
        # 1. Registrar entrada
        entrada = {"producto_id": 1, "cantidad": 50, "motivo": "Compra inicial"}
        ...
        # 3. Registrar salida
        salida = {"producto_id": 1, "cantidad": 25, "motivo": "Venta"}
