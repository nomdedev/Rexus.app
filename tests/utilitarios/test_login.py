...
import unittest
    ...
    def test_login_admin(self):
        self.login_view.usuario_input.setText("TEST_USER")
        self.login_view.password_input.setText("TEST_USER")
        ...
        if user is not None:
            self.assertEqual(user["usuario"], "TEST_USER")
            self.assertEqual(user["rol"], "TEST_USER")
