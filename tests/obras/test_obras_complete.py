...
class TestObrasBasic:
    """Tests básicos para el módulo obras."""
    ...
    def test_modulo_importable(self):
        ...
        try:
            ...
            pytest.skip(f"Módulo obras no disponible")

    def test_estructura_modulo(self):
        """Test: verificar estructura básica del módulo."""
        modulo_path = ROOT_DIR / 'modules' / 'obras'
        assert modulo_path.exists(), f"Directorio del módulo obras debe existir"

        # Buscar archivos Python
        archivos_py = list(modulo_path.glob('*.py'))
        assert len(archivos_py) > 0, f"Módulo obras debe tener al menos un archivo Python"
    ...
    def test_controller_existe(self):
        ...
        try:
            ...
            pytest.skip(f"Controller de obras no disponible")
...
class TestObrasEdgeCases:
    """Tests de edge cases para el módulo obras."""
