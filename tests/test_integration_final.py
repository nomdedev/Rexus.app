#!/usr/bin/env python3
"""
Pruebas finales de integración corregidas para el sistema Rexus.app
...
class IntegrationTester:
    ...
    def test_module_import(self, module_name):
        ...
        try:
            # Usar importlib para manejar nombres de módulos con números
    ...
    def test_main_modules(self):
        ...
        main_modules = [
            ...
            'rexus.modules.12_configuracion',
            'rexus.modules.13_notificaciones'
        ]
    ...
    def test_controllers(self):
        ...
        controller_modules = [
            'rexus.modules.01_obras.controller',
    ...
    def test_business_workflows(self):
        """Prueba flujos de negocio clave"""
        print("\n=== PRUEBA DE FLUJOS DE NEGOCIO ===")
        
        try:
            # Importar módulos funcionales usando importlib
            ...
            self.results['modules_imported'].append('business_workflows')
            
            # Probar integración básica
            print("OK Integración de modelos - Funcional")
            
        except Exception as e:
            error_msg = f"Error en flujo de negocio: {str(e)}"
            self.results['modules_failed'].append('business_workflows')
            print(f"ERROR Flujo de negocio: {str(e)}")
...
if __name__ == "__main__":
    ...
    # Guardar reporte
    import json
    with open('tests/integration_final_report.json', 'w', encoding='utf-8') as f:
        json.dump(report, f, indent=2, ensure_ascii=False)
    
    print(f"\nReporte guardado en: tests/integration_final_report.json")
