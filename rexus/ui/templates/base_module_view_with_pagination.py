...
class BaseModuleViewWithPagination(BaseModuleView):
    ...
    def load_paginated_data(self, page: int, page_size: int) -> dict:
        ...
        """
        if hasattr(self, 'model') and hasattr(self.model, 'obtener_datos_paginados'):
            return self.model.obtener_datos_paginados(page, page_size, self.current_search_term, self.current_filters)
