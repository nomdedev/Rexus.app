...
from ..utils.feedback_manager import get_feedback_manager, FeedbackManager
...
class FeedbackMixin:
    ...
    def mostrar_mensaje(self, titulo: str, mensaje: str, tipo: str = "info") -> int:
        """
        ...
        return self._feedback_manager.show_message(self, titulo, mensaje, tipo)
    ...
    def mostrar_confirmacion(self, titulo: str, mensaje: str, 
        ...
        return self._feedback_manager.show_confirmation(self, titulo, mensaje, botones)
    ...
    def mostrar_status(self, mensaje: str, tipo: str = "info", duration: int = 3000, 
        ...
        # Mostrar el mensaje
        self._feedback_manager.show_status_message(label, mensaje, tipo, duration)
    ...
    def mostrar_exito(self, mensaje: str, duration: int = 3000, label_name: str = "default"):
        """Mostrar mensaje de éxito"""
        self.mostrar_status(mensaje, "success", duration, label_name)
    
    def mostrar_error(self, mensaje: str, duration: int = 5000, label_name: str = "default"):
        """Mostrar mensaje de error"""
        self.mostrar_status(mensaje, "error", duration, label_name)
    
    def mostrar_advertencia(self, mensaje: str, duration: int = 4000, label_name: str = "default"):
        """Mostrar mensaje de advertencia"""
        self.mostrar_status(mensaje, "warning", duration, label_name)
    
    def mostrar_info(self, mensaje: str, duration: int = 3000, label_name: str = "default"):
    ...
    def mostrar_toast(self, mensaje: str, tipo: str = "info", duration: int = 4000, toast_name: str = "default"):
        """
    ...
    def actualizar_status_indicator(self, status: str, mensaje: str = "", indicator_name: str = "default"):
        """
