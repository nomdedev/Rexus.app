...
class ProductosModel:
    ...
    def get_products_by_type(self, tipo_producto: str, active_only: bool = True) -> List[Dict[str, Any]]:
        """
        Obtiene productos de un tipo específico.
        
        Args:
            tipo_producto: Tipo de producto (INVENTARIO, HERRAJE, VIDRIO, MATERIAL)
    ...
    def validate_product_data(self, product_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Validar estado
        if product_data.get('estado') and product_data['estado'] not in self.ESTADOS_PRODUCTO:
