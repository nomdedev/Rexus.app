...
class LogisticaController(QObject):
    ...
    def cargar_entregas(self):
        ...
        try:
            ...
            error_msg = f"Error cargando entregas: {str(e)}"
    ...
    def cargar_services(self):
        ...
        try:
            ...
            error_msg = f"Error cargando servicios: {str(e)}"
            logger.error(error_msg)
            self.mostrar_error(error_msg)
    ...
    def buscar_transportes(self, termino, estado):
        ...
        try:
            if self.model and hasattr(self.model, 'buscar_transportes'):
                ...
                logger.info("Usando transportes simulados")
            ...
            error_msg = f"Error buscando transportes: {str(e)}"
            logger.error(error_msg)
            self.mostrar_error(error_msg)
            return []
    ...
    def cargar_estadisticas(self):
        ...
        try:
            ...
            if self.view:
                ...
                logger.debug("Estadísticas actualizadas en vista")
