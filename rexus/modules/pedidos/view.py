...
from rexus.modules.pedidos.improved_dialogs import (
    PedidoDetalleDialog,
    PedidoDialogManager,
    PedidoEstadoDialog,
)
...
class PedidosView(QWidget):
    ...
    def editar_pedido_mejorado(self):
        ...
        if not self.pedido_actual:
            show_warning(
                self, "Sin selección", "Por favor seleccione un pedido para editar."
            )
            return
    ...
    def eliminar_pedido_mejorado(self):
        ...
        if not self.pedido_actual:
            show_warning(
                self, "Sin selección", "Por favor seleccione un pedido para eliminar."
            )
            return
    ...
    def gestionar_detalle_mejorado(self):
        ...
        if not self.pedido_actual:
            show_warning(
                self,
                "Sin selección",
                "Por favor seleccione un pedido para gestionar su detalle.",
            )
            return
