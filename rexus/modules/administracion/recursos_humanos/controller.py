...
# Crear empleado usando método auxiliar
if self.helper_crear_empleado(datos_empleado):
...
empleados_error += 1
        ...
        logger.error(f"Error importando empleados desde CSV: {e}")
return False

return True

def helper_crear_empleado(self, datos_empleado):
