...
class UserSecurityManager:
    ...
    def register_login_attempt(self, username: str, success: bool, ip_address: str = "unknown") -> Dict[str, Any]:
        """
    ...
    def update_last_login(self, user_id: int, login_time: datetime.datetime, ip_address: str):
