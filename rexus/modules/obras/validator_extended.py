...
class ObrasValidatorExtended:
    ...
    @classmethod
    def validar_obra_completa(cls, obra_dict: Dict[str, Any]) -> Tuple[bool, List[str]]:
        """
    ...
    @classmethod
    def _validar_campos_basicos(cls, obra_dict: Dict[str, Any]) -> Tuple[bool, List[str]]:
    ...
    @classmethod
    def _validar_formatos(cls, obra_dict: Dict[str, Any]) -> Tuple[bool, List[str]]:
    ...
    @classmethod
    def _validar_seguridad(cls, obra_dict: Dict[str, Any]) -> Tuple[bool, List[str]]:
    ...
    @classmethod
    def _validar_reglas_negocio(cls, obra_dict: Dict[str, Any]) -> Tuple[bool, List[str]]:
    ...
    @classmethod
    def _validar_integridad(cls, obra_dict: Dict[str, Any]) -> Tuple[bool, List[str]]:
    ...
    @classmethod
    def validar_y_sanitizar(cls, obra_dict: Dict[str, Any]) -> Tuple[bool, Dict[str, Any], List[str]]:
        """
