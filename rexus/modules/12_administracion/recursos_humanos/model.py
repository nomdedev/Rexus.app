...
class RecursosHumanosModel:
    ...
    def _verificar_tablas(self):
        ...
        try:
            ...
            for tabla in tablas:
                query = self.sql_manager.get_query("recursos_humanos", "verificar_tabla_empleados")
    ...
    def obtener_todos_empleados(self, filtros=None):
        ...
        try:
            ...
            where_clause, params = self._build_empleados_where_clause(filtros)
    ...
    def _build_empleados_where_clause(self, filtros):
        """
        Construye el WHERE dinámico y los parámetros para la consulta de empleados.
        """
    ...
    def crear_empleado(self, datos_empleado):
        ...
        try:
            ...
            query = self.sql_manager.get_query('recursos_humanos', 'insertar_empleado')
    ...
    def guardar_nomina(self, nomina_data):
        ...
        try:
            ...
            for nomina in nomina_data:
                ...
                query_verificar = self.sql_manager.get_query("recursos_humanos", "verificar_nomina_existente")
                cursor.execute(query_verificar, (nomina['empleado_id'], nomina['mes'], nomina['anio']))

                if cursor.fetchone():
                    # Actualizar registro existente
                    query = self.sql_manager.get_query("recursos_humanos", "actualizar_nomina")
                    cursor.execute(query, (
                    ...
                    query = self.sql_manager.get_query("recursos_humanos", "insertar_nomina")
                    cursor.execute(query, (
                        nomina['empleado_id'], nomina['mes'], nomina['anio'],
                        nomina['salario_base'], nomina['dias_trabajados'], nomina['horas_extra'],
                        nomina['bonos'], nomina['descuentos'], nomina['faltas'],
...
# MÉTODOS PARA ASISTENCIAS
    ...
    def registrar_asistencia(self, datos_asistencia):
        ...
        try:
            ...
            query = self.sql_manager.get_query("recursos_humanos", "registrar_asistencia")
    ...
    def obtener_asistencias(self,
        ...
        try:
            ...
            query = self.sql_manager.get_query("recursos_humanos", "obtener_asistencias")
...
# MÉTODOS PARA BONOS Y DESCUENTOS
    ...
    def crear_bono_descuento(self, datos_bono):
        ...
        try:
            ...
            # Usar SQL externo
            query = self.sql_manager.get_query("recursos_humanos", "crear_bono_descuento")
    ...
    def obtener_bonos_descuentos(self, empleado_id=None, mes=None, anio=None):
        ...
        try:
            ...
            # Usar SQL externo
            base_query = self.sql_manager.get_query("recursos_humanos", "obtener_bonos_descuentos")
            where_clause = " AND ".join(conditions)
            query = base_query.replace("{{WHERE_CONDITIONS}}", where_clause)
...
# MÉTODOS PARA HISTORIAL
    ...
    def obtener_historial_laboral(self, empleado_id=None, tipo=None):
        ...
        try:
            ...
            # Usar SQL externo
            base_query = self.sql_manager.get_query("recursos_humanos", "obtener_historial_laboral")
            where_clause = " AND ".join(conditions)
            query = base_query.replace("{{WHERE_CONDITIONS}}", where_clause)
    ...
    def obtener_estadisticas_empleados(self):
        ...
        try:
            ...
            query = self.sql_manager.get_query("recursos_humanos", "nomina_mensual")
    ...
    def _calcular_dias_trabajados(self, empleado_id, mes, anio):
        ...
        try:
            ...
            query = self.sql_manager.get_query("recursos_humanos", "calcular_dias_trabajados")
    ...
    def _calcular_horas_extra(self, empleado_id, mes, anio):
        ...
        try:
            ...
            query = self.sql_manager.get_query("recursos_humanos", "calcular_horas_extra")
            cursor.execute(query, (empleado_id, mes, anio))
            resultado = cursor.fetchone()
    ...
    def _obtener_bonos_periodo(self, empleado_id, mes, anio):
        ...
        try:
            ...
            query = self.sql_manager.get_query("recursos_humanos", "obtener_bonos_periodo")
            cursor.execute(query, (empleado_id, mes, anio))
            resultado = cursor.fetchone()
            return float(resultado[0]) if resultado and resultado[0] else 0.0
    ...
    def _obtener_descuentos_periodo(self, empleado_id, mes, anio):
        ...
        try:
            ...
            query = self.sql_manager.get_query("recursos_humanos", "obtener_descuentos_periodo")
            cursor.execute(query, (empleado_id, mes, anio))
            resultado = cursor.fetchone()
            return float(resultado[0]) if resultado and resultado[0] else 0.0
    ...
    def _calcular_faltas(self, empleado_id, mes, anio):
        ...
        try:
            ...
            query = self.sql_manager.get_query("recursos_humanos", "calcular_faltas")
            cursor.execute(query, (empleado_id, mes, anio))
            resultado = cursor.fetchone()
            return resultado[0] if resultado else 0
