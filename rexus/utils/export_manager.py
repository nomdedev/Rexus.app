...
class ExportManager:
    ...
    def export_data(self, 
        ...
        try:
            ...
            if export_format == 'excel':
                return self._export_to_excel(data, headers, filename, parent_widget)
            elif export_format == 'csv':
                return self._export_to_csv(data, headers, filename, parent_widget)
            elif export_format == 'pdf':
                return self._export_to_pdf(data, headers, filename, parent_widget)
    ...
    def _export_to_excel(self, data: List[Dict], headers: List[str], filename: str, parent_widget: QWidget) -> bool:
    ...
    def _export_to_csv(self, data: List[Dict], headers: List[str], filename: str, parent_widget: QWidget) -> bool:
    ...
    def _export_to_pdf(self, data: List[Dict], headers: List[str], filename: str, parent_widget: QWidget) -> bool:
    ...
    def validate_data_for_export(self, data: List[Dict], headers: List[str]) -> tuple[bool, str]:
        """
