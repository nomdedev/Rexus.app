...
class FeedbackManager(QObject):
    ...
    def _on_theme_changed(self, theme_name: str, theme_colors: Dict[str, str]):
    ...
    def show_message(self, parent: QWidget, titulo: str, mensaje: str, tipo: str = "info") -> int:
        """
...
def show_message(parent: QWidget, titulo: str, mensaje: str, tipo: str = "info") -> int:
