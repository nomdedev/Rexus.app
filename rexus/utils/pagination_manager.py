...
class PaginationManager:
    ...
    def _validate_pagination_params(self,
page: int,
...
search_term: str = "",
    ...
    def get_paginated_data(self,
        ...
        cache_key = self._generate_cache_key(page,
page_size,
            search_term,
            filters)
        ...
        try:
            ...
            # Obtener datos
            data = self._fetch_page_data(offset,
page_size,
                search_term,
                filters,
                order_by)
        ...
        try:
            ...
            for i in range(1, pages_to_prefetch + 1):
                ...
                if next_page <= math.ceil(self.get_total_count(search_term, filters) / page_size):
                    ...
                    self.get_paginated_data(next_page,
page_size,
                        search_term,
                        filters)
...
class InventarioModel:
    ...
    def obtener_productos_paginados(self,
page=1,
        page_size=50,
        search_term="",
        filters=None):
