...
class FormValidationManager:
    ...
    def add_field_validator(self, field_name: str, validator: Callable[[Any], ValidationResult]):
    ...
    def add_custom_validator(self, name: str, validator: Callable[[Dict], ValidationResult]):
    ...
    def create_length_validator(self, field_name: str, min_length: int = 0, max_length: int = None):
    ...
    def create_number_range_validator(self, field_name: str, min_value: float = None, max_value: float = None):
