...
class FormValidator:
    ...
    @staticmethod
    def validar_campo_obligatorio(campo, valor: str, nombre_campo: str) -> Tuple[bool, str]:
        """
    ...
    @staticmethod
    def validar_fecha(campo, fecha: QDate, fecha_minima: Optional[QDate] = None) -> Tuple[bool, str]:
        """Valida una fecha."""
    ...
    @staticmethod
    def validar_longitud_texto(campo, texto: str, min_len: int = 0, max_len: int = 1000) -> Tuple[bool, str]:
